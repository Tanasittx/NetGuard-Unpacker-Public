...
namespace de4dot.blocks.cflow {
	public class Real8Value : Value {
	    ...
	    public static Real8Value Add(Int32Value a, Real8Value b)
	    {
	        if (!a.AllBitsValid() || !b.IsValid)
	            return CreateUnknown();
	        return new Real8Value(a.Value + b.Value);
	    }
	    public static Real8Value Add(Real8Value a, Int32Value b)
	    {
	        if (!a.IsValid || !b.AllBitsValid())
	            return CreateUnknown();
	        return new Real8Value(a.Value + b.Value);
	    }
