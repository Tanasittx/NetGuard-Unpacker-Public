...
namespace de4dot.blocks {
	public class Instr {
		...
		public bool IsArithmetic() {
			...
			return ins.OpCode == OpCodes.Add || ins.OpCode == OpCodes.Add_Ovf || ins.OpCode == OpCodes.Add_Ovf_Un || (ins.OpCode == OpCodes.Sub || ins.OpCode == OpCodes.Sub_Ovf || ins.OpCode == OpCodes.Sub_Ovf_Un) || (ins.OpCode == OpCodes.Mul || ins.OpCode == OpCodes.Mul_Ovf || ins.OpCode == OpCodes.Mul_Ovf_Un) || (ins.OpCode == OpCodes.Div || ins.OpCode == OpCodes.Div_Un) || ins.OpCode == OpCodes.Shl || (ins.OpCode == OpCodes.Shr || ins.OpCode == OpCodes.Shr_Un) || (ins.OpCode == OpCodes.Rem || ins.OpCode == OpCodes.Rem_Un) || (ins.OpCode == OpCodes.And || ins.OpCode == OpCodes.Or || ins.OpCode == OpCodes.Xor) || (ins.OpCode == OpCodes.Neg || ins.OpCode == OpCodes.Not);
		}
		public bool isConv() {
			return instruction.OpCode == OpCodes.Conv_I || instruction.OpCode == OpCodes.Conv_I1 || instruction.OpCode == OpCodes.Conv_I2 || instruction.OpCode == OpCodes.Conv_I4 || instruction.OpCode == OpCodes.Conv_I8 || instruction.OpCode == OpCodes.Conv_Ovf_I || instruction.OpCode == OpCodes.Conv_Ovf_I1 || instruction.OpCode == OpCodes.Conv_Ovf_I1_Un || instruction.OpCode == OpCodes.Conv_Ovf_I2 || instruction.OpCode == OpCodes.Conv_Ovf_I2_Un || instruction.OpCode == OpCodes.Conv_Ovf_I4 || instruction.OpCode == OpCodes.Conv_Ovf_I4_Un || instruction.OpCode == OpCodes.Conv_Ovf_I8 || instruction.OpCode == OpCodes.Conv_Ovf_I8_Un || instruction.OpCode == OpCodes.Conv_Ovf_I_Un || instruction.OpCode == OpCodes.Conv_Ovf_U || instruction.OpCode == OpCodes.Conv_Ovf_U1 || instruction.OpCode == OpCodes.Conv_Ovf_U1_Un || instruction.OpCode == OpCodes.Conv_Ovf_U2 || instruction.OpCode == OpCodes.Conv_Ovf_U2_Un || instruction.OpCode == OpCodes.Conv_Ovf_U4 || instruction.OpCode == OpCodes.Conv_Ovf_U4_Un || instruction.OpCode == OpCodes.Conv_Ovf_U8 || instruction.OpCode == OpCodes.Conv_Ovf_U8_Un || instruction.OpCode == OpCodes.Conv_Ovf_U_Un || instruction.OpCode == OpCodes.Conv_R8 || instruction.OpCode == OpCodes.Conv_R4 || instruction.OpCode == OpCodes.Conv_R_Un || instruction.OpCode == OpCodes.Conv_U || instruction.OpCode == OpCodes.Conv_U1 || instruction.OpCode == OpCodes.Conv_U2 || instruction.OpCode == OpCodes.Conv_U4 || instruction.OpCode == OpCodes.Conv_U8;
		}
